  ...
  return (
    ...
    <TouchableOpacity
      ...
      <View style={styles.navigationBar}>
        ...
        <TouchableOpacity onPress={() => navigate('/profile')} style={styles.topBarSections} />
        ...
        >
          <Image style={styles.navImgs.home} source={require('../assets/dept.png')} />
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            >
              ...
              <Text style={styles.optionText}>Consultancy/Corporate Training</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.optionButton}
