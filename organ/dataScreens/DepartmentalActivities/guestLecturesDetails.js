...
const GuestLecturesDetails = () => {
    const [data, setData] = useState(null)
    const [sno, setSno] = useState(1)

    async function fetchData() {
        const apiUrl = 'https://pi360.net/site/api/api_dept_guest_lectures_details.php?institute_id=mietjammu&rs=10';
        ...
        <React.Fragment>
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                <ScrollView style={styles.container}>
                    ...
                    <Card title="Topics" data={data["Lecture_Detail"]["Topics"]}></Card>
                    <Card title="Lecture Type" data={data["Lecture_Detail"]["Lecture_Type"]}></Card>
                    <Card title="Guest Details(s)" data={data["Lecture_Detail"]["Guest_Details(s)"]}></Card>
                    <Card title="Institute Agency" data={data["Lecture_Detail"]["Institute_Agency"]}></Card>
                    <Card title="Details" data={data["Lecture_Detail"]["Details"]}></Card>
