...
const SeminarsDetails = () => {
    ...
    async function fetchData() {
        const apiUrl = 'https://pi360.net/site/api/api_staff_development_seminars_details.php?institute_id=mietjammu&rs=12';
            ...
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                data === 404 ? <View style={styles.LoadingContainer}><Text style={[styles.LoadingContainer.text, { color: "red" }]}>Network Error</Text></View> :
                    <ScrollView style={styles.container}>
                         <Card title="Seminar Name" data={data["Seminar_Detail"]["Seminar_Name"]}></Card>
                        <Card title="Seminar Description" data={data["Seminar_Detail"]["Seminar_Description"]}></Card> 
                        <Card title="Mode" data={data["Seminar_Detail"]["Mode"]}></Card>
                        <Card title="Course Provider" data={data["Seminar_Detail"]["Course_Provider"]}></Card>
                        <Card title="Duration" data={data["Seminar_Detail"]["Duration"]}></Card>
                        <Card title="Total Duration Hours" data={data["Seminar_Detail"]["Total_Duration_Hours"]}></Card>
                        <Card title="Attened By" data={data["Seminar_Detail"]["Attened_By"]}></Card>
