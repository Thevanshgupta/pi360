...
const SeminarsList = () => {
    ...
    async function fetchData() {
        const apiUrl = 'https://pi360.net/site/api/api_staff_development_seminars_list.php?institute_id=mietjammu';
        ...
        <View style={styles.container}>
            ...
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                <React.Fragment><View style={styles.titleHead}>
                    ...
                    <View style={styles.section3}><Text style={styles.section3.title}>Duration</Text></View>
                </View><FlatList
                        data={data}
                        renderItem={({ item, index }) => <Card title={item["Seminar_Detail"]["Seminar_Name"]} date={item["Seminar_Detail"]["Duration"]} sno={index}></Card>}
