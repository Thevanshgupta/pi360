...
const MembershipList = () => {
    ...
    async function fetchData() {
        const apiUrl = 'https://pi360.net/site/api/api_staff_memberships_list.php?institute_id=mietjammu';
        ...
        <View style={styles.container}>
            ...
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                <React.Fragment><View style={styles.titleHead}>
                    ...
                    <View style={styles.section3}><Text style={styles.section3.title}>Member From</Text></View>
                </View><FlatList
                        data={data}
                        renderItem={({ item, index }) => <Card title={item["Membership_Detail"]["Membership Details"]} date={item["Membership_Detail"]["Member_From"]} sno={index}></Card>}
