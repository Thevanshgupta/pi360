...
const TrainingDetails = () => {
  ...
  async function fetchData() {
    const apiUrl =
      'https://pi360.net/site/api/api_staff_development_training_details.php?institute_id=mietjammu&rs=10';
    ...
    <React.Fragment>
      {data === null ? (
        ...
        <ScrollView style={styles.container}>
          <Card
            title="Training_Name"
            data={data['Training_Detail']['Training_Name']}></Card>
          <Card
            title="Training Description"
            data={data['Training_Detail']['Training_Description']}></Card>
          <Card title="Mode" data={data['Training_Detail']['Mode']}></Card>
          <Card
            title="Course Provider"
            data={data['Training_Detail']['Course_Provider']}></Card>
          <Card
            title="Duration"
            data={data['Training_Detail']['Duration']}></Card>
          <Card
            title="Total Duration Hours"
            data={data['Training_Detail']['Total_Duration_Hours']}></Card>
          <Card
            title="Attened By"
            data={data['Training_Detail']['Attened_By']}></Card>
          <Card
