...
const ConferencesDetails = () => {
  ...
  async function fetchData() {
    const apiUrl =
      'https://pi360.net/site/api/api_staff_development_conference_details.php?institute_id=mietjammu&rs=12';
      ...
      {data === null ? (
        ...
        <ScrollView style={styles.container}>
          <Card
            ...
            data={data['Conference_Detail']['Conference_Name']}></Card>
          <Card title="Conference Description" data={data['Conference_Detail']['Conference_Description']}></Card>
          <Card
            title="Agency"
            data={data['Conference_Detail']['Agency']}></Card>
          <Card
            title="Course Venue"
            data={data['Conference_Detail']['Course_Venue']}></Card>
          <Card
            title="Duration"
            data={data['Conference_Detail']['Duration']}></Card>
          <Card
