        ...
        <View style={styles.container}>
            ...
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                <React.Fragment><View style={styles.titleHead}>
                    ...
                    <View style={styles.section3}><Text style={styles.section3.title}>Launched On</Text></View>
                </View><FlatList
                        data={data}
                        renderItem={({ item, index }) => <Card title={item["Content_Detail"]["Module_Name"]} date={item["Content_Detail"]["Launched_On"]} sno={index}></Card>}
