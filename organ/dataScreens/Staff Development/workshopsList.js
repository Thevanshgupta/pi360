...
const WorkshopList = () => {
    ...
    async function fetchData() {
        const apiUrl = 'https://pi360.net/site/api/api_staff_development_workshops_list.php?institute_id=mietjammu';
            ...
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                <React.Fragment><View style={styles.titleHead}>
                    ...
                    <View style={styles.section3}><Text style={styles.section3.title}>Filing Date</Text></View>
                        ...
                        data={data}
                        renderItem={({ item, index }) => <Card title={item["Workshop_Detail"]["Workshop_Name"]} date={item["Workshop_Detail"]["Duration"]} sno={index}></Card>}
