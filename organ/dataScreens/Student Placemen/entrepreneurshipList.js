...
const EntrepreneurshipList = () => {
    ...
    async function fetchData() {
        const apiUrl = 'https://pi360.net/site/api/api_student_entrepreneurship_list.php?institute_id=mietjammu';
        ...
        <View style={styles.container}>
            ...
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                <React.Fragment><View style={styles.titleHead}>
                    ...
                    <View style={[styles.section2, styles.section2.cent]}><Text style={styles.section2.title}>Student Name </Text></View>
                    <View style={styles.section3}><Text style={styles.section3.title}>Startup Name</Text></View>
                </View><FlatList
                        data={data}
                        renderItem={({ item, index }) => <Card title={item["Student_Detail"]["Student"]} date={item["Startup_Detail"]["Startup_Name"]} sno={index}></Card>}
