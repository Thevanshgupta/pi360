        ...
        <View style={styles.container}>
            ...
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                <React.Fragment><View style={styles.titleHead}>
                    ...
                    <View style={styles.section3}><Text style={styles.section3.title}>Batch</Text></View>
                </View><FlatList
                        data={data}
                        renderItem={({ item, index }) => <Card title={item["Student_Detail"]["Student"]} date={item["Higher_Studies_Detail"]["Batch"]} sno={index}></Card>}
...
export default HigherStudiesList;
