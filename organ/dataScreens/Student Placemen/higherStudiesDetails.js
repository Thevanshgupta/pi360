...
const HigherStudiesDetails = () => {
    ...
    async function fetchData() {
        const apiUrl = 'https://pi360.net/site/api/api_student_higher_studies_details.php?institute_id=mietjammu&rs=6064';
            ...
            {data === null ? <View style={styles.LoadingContainer}><Text style={styles.LoadingContainer.text}>Loading...</Text></View> :
                data === 404 ? <View style={styles.LoadingContainer}><Text style={[styles.LoadingContainer.text, { color: "red" }]}>Network Error</Text></View> :
                    <ScrollView style={styles.container}>
                        ...
                        <Card title="Department" data={data["Student_Detail"]["Department"]}></Card> 
                        <Card title="Student Batch" data={data["Student_Detail"]["Student_Batch"]}></Card>
                        <Card title="Institute Name" data={data["Higher_Studies_Detail"]["Institute_Name"]}></Card>
                        <Card title="Qualifying Exam" data={data["Higher_Studies_Detail"]["Qualifying_Exam"]}></Card>
                        <Card title="Status" data={data["Higher_Studies_Detail"]["Status"]}></Card>
                        <Card title="Admission Date" data={data["Higher_Studies_Detail"]["Admission_Date"]}></Card>
                        <Card title="Proof of Acceptance(pdf)" data={<Text style={{ color: 'blue' }}
                            onPress={() => Linking.openURL("https:\/\/pi360.net\/mietjammu" + data["Content_Detail"]["Acceptance_Proof"].replace(/\//g, "/"))}>
                            Download
                        </Text>}></Card>
...
export default HigherStudiesDetails;
