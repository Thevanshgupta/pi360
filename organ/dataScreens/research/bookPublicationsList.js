...
const BookPublicationsList = () => {
  ...
  async function fetchData() {
    const apiUrl =
      'https://pi360.net/site/api/api_books_publication_list.php?%20institute_id=mietjammu';
      ...
      {isLoading ? (
        ...
        <>
          <View style={styles.titleHead}>
            ...
            <View style={[styles.section2, styles.section2.cent]}>
              <Text style={styles.section2.title}> Book Title</Text>
            </View>
            <View style={styles.section3}>
              <Text style={styles.section3.title}>Published On</Text>
            </View>
          </View>
          <FlatList
            data={data}
