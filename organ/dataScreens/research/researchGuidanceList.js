...
const ResearchGuidanceList = () => {
  ...
  async function fetchData() {
    const apiUrl = 'https://pi360.net/site/api/api_research_guide_list.php?%20institute_id=mietjammu';
      ...
      {isLoading ? (
        ...
        <>
          <View style={styles.titleHead}>
            ...
            <View style={[styles.section2, styles.section2.cent]}>
              <Text style={styles.section2.title}>Thesis Title</Text>
            </View>
            <View style={styles.section3}>
              <Text style={styles.section3.title}>Scholar Name</Text>
            </View>
          </View>
          <FlatList
            data={data}
            renderItem={({ item, index }) => (
              <Card title={item["Guide_Details"]["Thesis_Title"]} date={item["Guide_Details"]["Scholar_Name"]} sno={index} />
            )}
