  ...
  return (
    <View style={styles.dataCard}>
      ...
      <View style={styles.section2}>
        <Text
          onPress={() => {
            navigate('/data/StaffAchievementDetails/' + code);
          }}
          numberOfLines={3}
...
const StaffAchievementsList = () => {
  ...
  async function fetchData() {
    const apiUrl =
      'https://pi360.net/site/api/api_staff_achievements_list.php?institute_id=mietjammu';
  ...
  return (
    <View style={styles.container}>
        ...
        <>
          <View style={styles.titleHead}>
            ...
            <View style={[styles.section2, styles.section2.cent]}>
              <Text style={styles.section2.title}>Achievements</Text>
            </View>
            <View style={styles.section3}>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => (
              <Card
                sno={index}
                title={item?.Achievement_Detail?.Achievements || 'N/A'}
                date={item?.Achievement_Detail?.Date || 'N/A'}
                code={item?.code || 'N/A'}
              />
            )}
      ...
      <TouchableOpacity
        ...
        onPress={() => navigate('/data/STAFF ACHIEVEMENT')}>
